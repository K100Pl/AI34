% SY28 Project - Section II.ii: Odometrie Bruitee
% Les robots estiment leur pose par integration des vitesses AVEC bruit
% Objectif: Montrer comment l'incertitude de pose evolue avec le temps
...
save('OdometryError_Noisy.mat', 'odometry_error', 'total_odom_error', 'sigma_v', 'sigma_omega');

%% Affichage des statistiques ODOMETRIE (II.ii)
fprintf('\n=== SECTION II.ii: ODOMETRIE BRUITEE ===\n');
fprintf('Integration des vitesses AVEC bruit gaussien\n');
...
fprintf('\nEvolution de l''erreur dans le temps (DRIFT):\n');
